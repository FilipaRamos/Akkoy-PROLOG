...
\title{Uso das restrições em Programação Lógica:\\Puzzle Akkoy}

% a short form should be given in case it is too long for the running head
\titlerunning{Uso das restrições em Programação Lógica: Puzzle Akkoy}
...
\and Inês Santos}
%
\authorrunning{Uso das restrições em Programação Lógica: Puzzle Akkoy}
